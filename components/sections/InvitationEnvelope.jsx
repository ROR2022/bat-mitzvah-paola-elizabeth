...
function EnvelopeContent({ onOpen }) {
  ...
  return (
    <div
      style={{
        backgroundImage: `url('/images/logoPaola1.jpeg')`,
      ...
      onClick={handleOpen}
    >
      <div className="bg-slate-400 bg-opacity-80 flex flex-col items-center mb-16 text-amber-800 font-main-text text-lg mt-20">
        <h5>{inviteData ? "Invitación Para: " : ""}</h5>
        <div className="mt-2 text-2xl font-semibold">
          {inviteData ? inviteData.name : ""}
        </div>
